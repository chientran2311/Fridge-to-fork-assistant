...
import 'package:fridge_to_fork_assistant/screens/fridge_add_ingredients.dart';
...
class _FridgeHomeScreenState extends State<FridgeHomeScreen> {
  ...
  void deleteSelectedItems() {
    setState(() {
      ...
      var sortedIndices = selectedIndices.toList()..sort((a, b) => b.compareTo(a));
        ...
        title: isSelectionMode
            ? Row(
                children: [
                  ...
                  TextButton(
                    onPressed: selectedIndices.isEmpty ? null : showDeleteConfirmDialog,
                    child: Text(
                      "Save",
                      style: TextStyle(
                        color: selectedIndices.isEmpty ? Colors.grey : mainColor,
                        fontSize: 16,
                      ),
                    ),
                  ),
