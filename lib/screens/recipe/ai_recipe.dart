...
class _AIRecipeScreenState extends State<AIRecipeScreen> {
  ...
  final Color greenBadgeColor = const Color(0xFFE8F5E9); // Nền xanh nhạt của banner

  // Dữ liệu mẫu y hệt trong ảnh
  final List<Map<String, dynamic>> recipes = [
    {
      "image": "https://images.unsplash.com/photo-1551183053-bf91a1d81141?q=80&w=600&auto=format&fit=crop", // Ảnh Pasta Bơ
      "matchTag": "100% Match",
      "tagIcon": Icons.check_circle_outline,
      "title": "Creamy Avocado & Spinach Pesto Pasta",
      "desc": "A quick, protein-packed breakfast perfectly using your leftover sourdough.",
      "time": "15 min",
      "kcal": "320 kcal",
      "missing": 0,
      "isUrgent": false,
    ...
    {
      "image": "https://images.unsplash.com/photo-1626844131082-256783844137?q=80&w=600&auto=format&fit=crop", // Ảnh Pasta Lemon Basil
    ...
    {
      "image": "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=600&auto=format&fit=crop", // Ảnh Rau củ xào
      "matchTag": "100% Match",
      "tagIcon": Icons.check_circle_outline,
                      ...
                      Expanded(
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: const [
                              TextSpan(text: "Found 3 recipes to rescue your expiring ingredients. "),
                              TextSpan(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _InfoChip(icon: Icons.local_fire_department_outlined, text: data['kcal']),
                    _InfoChip(
                      icon: Icons.shopping_bag_outlined, 
                      text: "Missing: ${data['missing']}",
                      isHighlight: data['missing'] > 0, // Đổi màu nếu thiếu nguyên liệu
                    ),
                  ],
                )
              ],
...
class _InfoChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
      decoration: BoxDecoration(
        color: isHighlight ? const Color(0xFFFFF4E5) : const Color(0xFFF5F5F5), // Cam nhạt nếu highlight
