...
import '../../services/household_service.dart'; // Service quản lý household
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final HouseholdService _householdService = HouseholdService(); // Khởi tạo Household Service
  ...
  Future<void> _handleLogin() async {
    ...
    if (errorMessage == null) {
      // --- THÀNH CÔNG ---
      // Initialize household for user if not exists
